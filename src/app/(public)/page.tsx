...
export default async function ZonaGrillPage() {
  ...
  const heroSlides = content?.heroSlides || [
    {
      ...
      title: "LA CAVA\nDEL CORTE",
      description: "Las mejores parrilladas, pizzas y papas rellenas al carbón de mezquite natural.",
      mediaType: "IMAGE",
    ...
    },
    {
      ...
      title: "PARRILLADAS",
      description: "Disfruta de parrilladas premium cocinadas a fuego lento con leña 100% natural.",
      mediaType: "IMAGE",
  ...
  const fallbackFavorites = [
    {
      id: "fallback-1",
      name: "PAPA RELLENA MIXTA",
      image: "https://images.unsplash.com/photo-1544025162-d76694265947?w=600&auto=format&fit=crop&q=80",
      category: "Papas Rellenas",
      price: 220,
      description: "Papa gigante asada al carbón con puré cremoso, queso gouda fundido, Sirloin y chorizo argentino.",
    },
    {
      id: "fallback-2",
      name: "RESERVA DOBLE",
      ...
      price: 590,
      description: "Parrillada premium para compartir con variedad de carnes, complementos calientes y salsas.",
    },
    {
      id: "fallback-3",
